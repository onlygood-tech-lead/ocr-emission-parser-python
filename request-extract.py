...
# Example usage
image_path = "easy-extract/brsr-pg.png"  # Replace with your image file path
output_txt_path = "easy-extract/extracted_text.txt"  # Replace with your desired output file path
